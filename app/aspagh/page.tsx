...
export const metadata: Metadata = {
    ...
    description: `اصباغ في الكويت - خدمات صباغة ودهانات داخلية وخارجية باحترافية وبأفضل الأسعار. اتصل الآن على ${process.env.NEXT_PUBLIC_PHONE}`,
    openGraph: {
        url: `${process.env.NEXT_PUBLIC_APP_SITE}/aspagh`,
        title: `صباغ الكويت - ${process.env.NEXT_PUBLIC_PHONE} - صباغ شاطر ورخيص - اصباغ`,
        description: `اصباغ في الكويت - خدمات صباغة ودهانات داخلية وخارجية باحترافية وبأفضل الأسعار. اتصل الآن على ${process.env.NEXT_PUBLIC_PHONE}`,
        images: [
            {
                url: `${process.env.NEXT_PUBLIC_APP_SITE}/Images/links-images/aspagh.jpg`,
                alt: `صباغ الكويت - ${process.env.NEXT_PUBLIC_PHONE} - صباغ شاطر ورخيص - اصباغ`,
            },
        ],
        type: 'article',
    },
    alternates: {
        canonical: `${process.env.NEXT_PUBLIC_APP_SITE}/aspagh`,
    }
}
        ...
        <Container maxWidth="lg">
            <Stack my={5} spacing={3} alignItems={"center"}>
                ...
                <Stack alignItems="center" spacing={2}>
                    <ImageStyle src={"/Images/links-images/aspagh.jpg"} alt='اصباغ الكويت' />
